...
\livretfalse % Livret eleve sans les corrections
%%%%%


\input{01_multiphysique}
\input{../01_Revisions_ModelisationSystemes/02_modelisation_slci}
\input{03_performances_slci}
\input{04_correcteurs}
\input{04_chs}
\input{05_hyperstatisme}
\input{07_pfd_1d}
\input{08_geometrie}
\input{09_dynamique}
\input{10_methodologie}
\input{11_tec}
